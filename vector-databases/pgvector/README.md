...
There are several options that describe different ways to connect to your PostgreSQL cluster—whether directly via the `psql` command-line tool, through a secure port-forwarding setup, or by using a graphical interface like `pgAdmin`, as [explained here](https://nerc-project.github.io/nerc-docs/other-tools/postgres/postgres-cluster-setup/#postgresql-connection-methods).
