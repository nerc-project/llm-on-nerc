...
- [Hugging Face Text Generation Inference (TGI)](https://github.com/huggingface/text-generation-inference): how to deploy [TGI](llm-servers/hf-tgi/README.md).

- [vLLM](https://github.com/vllm-project/vllm): how to deploy **vLLM** server on NERC OpenShift, specifically [built for **CPU**](llm-servers/vllm/cpu/README.md) or [built for **GPU**](llm-servers/vllm/gpu/README.md).
